...
| `estudio.jpg`          | `src/assets/hero/estudio.jpg`                                                                     | 3882 × 2588, recorte 4:5    | Foto de los socios en la entrada del estudio (`sections/Hero.astro`, columna derecha)                              | ✅ Listo                                  |
...
- **Formato de origen**: JPG o PNG está bien — no hace falta convertir a WebP
  a mano, `<Image />` lo hace en el build. El logo de la marca sólo existe en
